package com.basant.spring.data.elasticsearch.api.config;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.basant.spring.data.elasticsearch.api.repository")
