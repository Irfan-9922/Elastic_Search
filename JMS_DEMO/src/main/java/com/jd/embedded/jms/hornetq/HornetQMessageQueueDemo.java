    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
           ...
           ObjectMessage mm = session.createObjectMessage(d);
            ...
            System.out.println("Sent message: " + mm.getObject());
            System.out.println("Sent message: " + message.getText());
            System.out.println("Sent port: " +queue.getQueueName());
            ...
            TextMessage messageReceived = (TextMessage) messageConsumer.receive(5000);
                                        ObjectMessage me   =  (ObjectMessage) messageConsumer.receive(500
                                        		);
            
            
            System.out.println("Received message: " + messageReceived.getText());
            System.out.println("Received message: " + me.getObject());
          System.out.println(messageReceived.getJMSDeliveryMode());
        }
        finally
        {
            if (connection != null) {
